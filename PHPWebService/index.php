<?php
	...
	function getStatusCodeMessage($status){
		...
		// via parse_init_file()...however, this will suffice
		//for an example
		$codes = Array(
			100	=> 'Continue',
...
// Helper method to send a HTTP response code/message
	...
	//Desturctor - close DB connection
	function __destruct() {
		$this->db->close();
	}
...
//Creates a new istance of the RedeemAPI class and calls the redeem method
$api = new RedeemAPI;
$api->redeem();

//This adds a constructor that connects to your database given a username and password and a destructor that closes
// the database conection. The redeem loop is modified to run a MySQL statement to select all of the entries
//in rw_promo_code, and loop through to print a line about each entry.
?>